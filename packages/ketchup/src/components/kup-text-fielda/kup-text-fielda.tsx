...
import { FTextFielda } from '../../f-components/f-text-fielda/f-text-fielda';
import { FTextFieldProps } from '../../f-components/f-text-fielda/f-text-fielda-declarations';
import {
    GenericObject,
    KupComponent,
    KupEventPayload,
...
import {
    ...
    KupTextFieldProps,
} from './kup-text-fielda-declarations';
import { KupDebugCategory } from '../../utils/kup-debug/kup-debug-declarations';
import { getProps, setProps } from '../../utils/utils';

@Component({
    tag: 'kup-text-fielda',
    styleUrl: 'kup-text-fielda.scss',
    shadow: true,
})
export class KupTextFielda {
    /**
     * References the root HTML element of the component (<kup-text-fielda>).
     */
