import type { FTextFieldProps } from './f-text-fielda-declarations';
...
export const FTextFielda: FunctionalComponent<FTextFieldProps> = (
    props: FTextFieldProps
) => {
    return (
        <div
            class={`f-text-fielda--wrapper ${
    ...
    if (props.icon) {
        ...
        iconEl = (
            <span
                tabindex="0"
                style={iconStyle}
                class={`material-icons text-field__icon icon-container action ${iconClass}`}
            ></span>
        );
    }
    ...
    return (
        <div class={classObj}>
            ...
            {props.isClearable ? (
                <span
                    tabindex="1"
                    class="material-icons text-field__icon icon-container clear"
                ></span>
            ) : undefined}
            {props.trailingIcon ? iconEl : undefined}
